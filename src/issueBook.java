...
public class issueBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 120, 200, 30));

        jTextField3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 160, 200, 30));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 320, 73, -1));
        getContentPane().add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 210, 200, 30));
        ...
        getContentPane().add(jDateChooser2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 260, 200, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ResultSet rs;
        String insertQuery = "insert into issue(bookID, studentID, issueDate, dueDate, returnBook) values(?,?,?,?,?)";
        PreparedStatement ps ;
        try
        {
          ps = ConnectionProvider.getCon().prepareStatement(insertQuery);
          ps.setString(1, bookID);
          ps.setString(2,studentID);
          ps.setString(3, issueDate);
          ps.setString(4,dueDate);
          ps.setString(5, returnBook);
       
          if(ps.executeUpdate() != 0){
          JOptionPane.showMessageDialog(null, "data have been  save in databaseueDate");
          }
          else
          {
